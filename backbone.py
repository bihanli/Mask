...
#        feature_maps,x=self.backbone_net.call(input1)
#        pred=self.net(feature_maps)
#        h=input2
...
class Mask(tf.keras.Model):
  ...
  def call(self,input1,input2):
      feature_maps,x=self.backbone_net.call(input1)
      output1=self.net.call(feature_maps)
      output2=self.Ypgru.call(x,input2)
